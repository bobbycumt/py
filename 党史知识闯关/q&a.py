...
media_dir=r"C:\Users\Administrator\Desktop\党史知识闯关" #图片背景音乐路径文件夹
...
questions = [
    ...
    {
        "question": "习近平新时代中国特色社会义思想的核心要义是(  )。\n",
        "options": ["A.实现中华民族伟大复兴", "B.坚持和发展中国特色社会主义", " C.促进人类和平进步发展"],
        "answer": 1
    },
    {
        "question": "中国梦是国家的梦、民族的梦，归根到底是(   )\n",
        "options": ["A.个人的梦", "B.集体的梦", "C.人民的梦"],
        "answer": 2
    },
    {
    ...
    {
        "question": "党的二十大报告指出，(  )是中国特色社会主义最本质的特征，\n是中国特色社会主义制度的最大优势。\n",
        "options": ["A.中国共产党的领导", "B.执政为民", "C.公有制"],
        "answer": 0
    },
...
class StartupPage(tk.Frame):
    ...
    def create_widgets(self):
        ...
        creator_label.pack()
        school_label = tk.Label(self, text="学校：唐山市第十二中学", font=("宋体", 18))
        school_label.pack()
    ...
    def start_game(self):
        ...
        game_window = tk.Tk()
        game_window.title("红色中国--党史知识闯关游戏（作者：唐山市第十二中学张朝翔）")
...
startup_window.title("红色中国--党史知识闯关游戏（作者：唐山市十二中学张朝翔）")
